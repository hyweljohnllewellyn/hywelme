...
1. This privacy policy applies only to the actions of Hywel Llewellyn and Users with respect to this Website. It does not extend to any websites that can be accessed from this Website including, but not limited to, any links we may provide to social media websites.

1. For purposes of the applicable Data Protection Laws, Hywel Llewellyn is the &quot;data controller&quot;. This means that Hywel Llewellyn determines the purposes for which, and the manner in which, your Data is processed.
...
1. Hywel Llewellyn will collect your Data in a number of ways, for example:
...
1. Any or all of the above Data may be required by us from time to time in order to provide you with the best possible service and experience when using our Website. Specifically, Data may be used by us for the following reasons:
  1. transmission by email of marketing materials that may be of interest to you;
...
1. We may share your Data with the following groups of people for the following reasons:
  1. third party service providers who provide services to us which require the processing of personal data - to help third party service providers in receipt of any shared data to perform functions on our behalf ;
...
1. Technical and organisational measures include measures to deal with any suspected data breach. If you suspect any misuse or loss or unauthorised access to your Data, please let us know immediately by contacting us via this e-mail address: llewellyn@gmail.com.
...
1. To make enquiries, exercise any of your rights set out above, or withdraw your consent to the processing of your Data (where consent is our legal basis for processing your Data), please contact us via this e-mail address: llewellyn@gmail.com.
...
1. Hywel Llewellyn may, from time to time, expand or reduce our business and this may involve the sale and/or the transfer of control of all or part of Hywel Llewellyn. Data provided by Users will, where it is relevant to any part of our business so transferred, be transferred along with that part and the new owner or newly controlling party will, under the terms of this privacy policy, be permitted to use the Data for the purposes for which it was originally supplied to us.
...
1. Hywel Llewellyn reserves the right to change this privacy policy as we may deem necessary from time to time or as may be required by law. Any changes will be immediately posted on the Website and you are deemed to have accepted the terms of the privacy policy on your first use of the Website following the alterations.

  You may contact Hywel Llewellyn by email at llewellyn@gmail.com.

**Attribution**

1. This privacy policy was created using a document from [Rocket Lawyer](https://www.rocketlawyer.com/gb/en/) (https://www.rocketlawyer.com/gb/en).
